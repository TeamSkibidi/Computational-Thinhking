...
// Dữ liệu mẫu - Dùng để lấy các block trong ngày 
export const BLOCK_CONFIG = [
    { id: 'morning', label: 'Buổi Sáng', defaultStart: '08:00', defaultEnd: '11:30', icon: 'fa-sun', iconClass: 'icon-amber', textClass: 'bg-amber' },
    { id: 'lunch', label: 'Ăn Trưa', defaultStart: '11:30', defaultEnd: '13:00', icon: 'fa-utensils', iconClass: 'icon-orange', textClass: 'bg-orange' },
    ...
    { id: 'dinner', label: 'Ăn Tối', defaultStart: '18:00', defaultEnd: '19:30', icon: 'fa-moon', iconClass: 'icon-indigo', textClass: 'bg-indigo' },
    { id: 'evening', label: 'Buổi đêm', defaultStart: '20:00', defaultEnd: '22:00', icon: 'fa-martini-glass', iconClass: 'icon-purple', textClass: 'bg-purple' },
];
